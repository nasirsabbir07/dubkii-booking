    ...
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
           ...
           class="nav-tab <?php echo ($active_tab === 'courses') ? 'nav-tab-active' : ''; ?>">
            ...
            <a href="<?php echo add_query_arg(array('page' => 'dubkii-booking', 'active_tab' => 'coupons'), admin_url('admin.php')); ?>" class="nav-tab <?php echo($active_tab === 'coupons') ? 'nav-tab-active' : ''; ?>">Coupons</a>
        </h2>
